...
namespace Reservation_vols_version2_withEF.Models
{
    public partial class Reservation_volsContext : DbContext
    {
        ...
        public virtual DbSet<VwTicket> VwTickets { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwTicket>(entity =>
            {
                ...
                entity.Property(e => e.Clientbirthdate)
                    .HasColumnType("timestamp without time zone")
                    .HasColumnName("clientbirthdate");

                entity.Property(e => e.Clientfirstname).HasColumnName("clientfirstname");

                entity.Property(e => e.Clientid).HasColumnName("clientid");

                entity.Property(e => e.Clientlastname).HasColumnName("clientlastname");
                ...
                entity.Property(e => e.Passengeraddress).HasColumnName("passengeraddress");

                entity.Property(e => e.Passengerbirthdate)
                    .HasColumnType("timestamp without time zone")
                    .HasColumnName("passengerbirthdate");

                entity.Property(e => e.Passengerfirstname).HasColumnName("passengerfirstname");

                entity.Property(e => e.Passengerid).HasColumnName("passengerid");

                entity.Property(e => e.Passengerlastname).HasColumnName("passengerlastname");

                entity.Property(e => e.Passengerphone).HasColumnName("passengerphone");
            });
